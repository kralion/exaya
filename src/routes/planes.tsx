    ...
    <LandingLayout>
      ...
      <div className="relative flex flex-col items-center justify-center gap-7 space-y-3.5 lg:my-7 lg:flex-row">
        ...
        <div className="relative">
          <span className="absolute -top-4 left-4 rounded-lg border border-orange-800 bg-black px-4 py-1 text-xs font-semibold uppercase tracking-wide text-white shadow-md shadow-orange-500">
            Popular
          </span>
          <PlanesCard
