...
function ProgramacionViajes() {
	return (
		<div className="bg-[#F3F1EF] p-7 h-auto rounded-l-xl flex flex-col gap-7 font-Literata">
			...
			<div className="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10 rounded-lg drop-shadow-lg">
				<form action="" className="flex gap-3 items-center">
					...
					<button className="bg-zinc-700 duration-200 text-white rounded-lg active:bg-zinc-900 ml-64 pt-1 pb-1.5  px-7">
						Crear
					</button>
				</form><div className="mt-7 overflow-x-auto">
