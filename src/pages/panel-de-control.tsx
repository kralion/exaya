	...
	return (
		<div className="flex flex-col gap-7 ">
			...
			<div className="flex gap-7">
				...
				<ControlPaneCard cardTitle="Viajes" cardDescription="Información sobre la cantidad de viajes programados para hoy" >
				...
				<ControlPaneCard cardDescription="Último código de boleto de viaje vendido." cardTitle="Boletos" >
					...
					<div className="flex justify-between items-center">
						...
						<div className="pt-7 flex flex-col gap-3">
							...
							<div className="flex gap-1 text-2xl items-center">
								<ContainerOutlined />
								<Typography.Text strong className="text-xl"  >B003548</Typography.Text>
							</div>
						</div>
					</div>
				...
				<ControlPaneCard cardDescription="Porcentaje de ocupación de asientos para cada viaje." cardTitle="Asientos Ocupados" >
