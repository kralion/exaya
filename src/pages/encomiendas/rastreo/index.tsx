...
export default function Page() {
  ...
  return (
    <div className="space-y-14 p-6 dark:bg-zinc-900">
      <Space direction="vertical">
        <h3 className=" text-xl font-bold text-amber-500 lg:text-3xl  ">
          Expreso Ayacucho
        </h3>
        <Text className="lg:text-md text-sm" type="secondary">
