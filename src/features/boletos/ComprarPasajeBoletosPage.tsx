...
export function ComprarPasajeBoletosPage({ viajeId }: { viajeId: string }) {
  ...
  async function createBoleto(values: z.infer<typeof boletoSchema>) {
    ...
    if (!apellidosCliente) return null;
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center rounded-b-lg py-16 dark:bg-zinc-900 lg:hidden">
            ...
            >
              ...
              >
                ...
                <text
                  ...
                  dy=".3em"
                  fontSize="6"
                  className="text-[7px] font-bold font-[Concert_One,sans-serif]"
                >
                  {seatNumber}
                </text>
              </svg>
        ...
        <Space direction="vertical" className="gap-4 py-2">
          <img
            src={viaje?.response?.bus.foto ?? fallbackImg}
            alt="bus"
            width={300}
              ...
              <Form.Item
                ...
                help={
                  form.getFieldValue("pasajeroDni") === ""
                    ...
                    ? `${reniecResponse.data?.nombres} ${reniecResponse.data?.apellidoPaterno} ${reniecResponse.data?.apellidoMaterno}`
                    : ""
                }
              >
                <Input
                  onChange={(e) => setPasajeroDNI(e.target.value)}
                  style={{ width: 320 }}
                  value={pasajeroDNI}
                  type="number"
                  maxLength={8}
