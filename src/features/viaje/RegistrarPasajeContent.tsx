...
interface RegistrarPasajeContentProps {
  viajeId: string;
}

export function RegistrarPasajeContent({ viajeId }: RegistrarPasajeContentProps) {
          ...
          >
            ...
            >
              ...
              <text
                ...
                dy=".3em"
                fontSize="6"
                className="font-[Concert_One,sans-serif] text-[7px] font-bold"
              >
                {seatNumber}
              </text>
            </svg>
